  ...
  FirebaseFirestore _database = FirebaseFirestore.instance;
    ...
    Future<bool> initNewUser(UserDataModel userDataModel) async {
      try {
        ...
        DocumentReference userDocRef = _database.collection('data').doc(userDataModel.authModel?.uid);
        ...
        await userDocRef.set({
          ...
          'gender': userDataModel.userModel?.Gender,
          'age': userDataModel.userModel?.Age,
          'country': userDataModel.userModel?.Country,
