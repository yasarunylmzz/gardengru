...
class _ListSavedItemsState extends State<ListSavedItems> {
  ...
  Widget build(BuildContext context) {
    ...
    void handleDismissed(u,i){
      final StorageHelper s = StorageHelper();
      s.DeleteSavedItemFromStorageAndStore(u, i);
      context.read<userRecordProvider>().removeSavedItem(i);
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: Colors.teal, // border rengi
